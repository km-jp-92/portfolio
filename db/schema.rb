...
ActiveRecord::Schema[7.2].define(version: 2025_11_28_112224) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["document_group_id"], name: "index_comments_on_document_group_id"
  end
  ...
  create_table "document_groups", force: :cascade do |t|
    ...
    t.index ["group_code"], name: "index_document_groups_on_group_code", unique: true
  ...
  add_foreign_key "comments", "document_groups", on_delete: :cascade
